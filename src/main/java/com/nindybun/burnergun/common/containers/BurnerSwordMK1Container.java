...
public class BurnerSwordMK1Container extends AbstractContainerMenu {
    BurnerSwordMK1Container(int windowId, Inventory playerInv, FriendlyByteBuf buf){
        this(windowId, playerInv, new BurnerSwordMK1Handler(MAX_EXPECTED_SWORD_SLOT_COUNT));
    }

    public BurnerSwordMK1Container(int windowId, Inventory playerInventory, BurnerSwordMK1Handler handler){
        super(ModContainers.BURNERSWORDMK1_CONTAINER.get(), windowId);
        this.handler = handler;
        this.setup(playerInventory);
    }

    private final BurnerSwordMK1Handler handler;
    ...
    public static int MAX_EXPECTED_SWORD_SLOT_COUNT = 6;
    ...
    public boolean stillValid(Player playerIn) {
        ...
        return (!main.isEmpty() && main.getItem() instanceof BurnerSwordMK1) ||
                (!off.isEmpty() && off.getItem() instanceof BurnerSwordMK1);
    }

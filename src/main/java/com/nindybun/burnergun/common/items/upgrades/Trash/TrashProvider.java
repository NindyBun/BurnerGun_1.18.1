...
public class TrashProvider implements ICapabilitySerializable<CompoundTag> {
    private final TrashHandler instance = new TrashHandler(TrashContainer.MAX_EXPECTED_HANDLER_SLOT_COUNT);

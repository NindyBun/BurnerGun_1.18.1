...
public class TestItemBagScreen extends AbstractContainerScreen<TestItemBagContainer> {
    public TestItemBagScreen(TestItemBagContainer container, Inventory playerInv, Component title) {
    ...
    protected void renderLabels(PoseStack matrixStack, int x, int y) {
        this.font.draw(matrixStack, new TranslatableComponent("tooltip." + BurnerGun.MOD_ID + ".screen.testitembag"), 2, -8, Color.WHITE.getRGB());
    }

...
import com.nindybun.burnergun.common.items.util_Inventory.UtilInventory;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> UTIL_INVENTORY = ITEMS.register("util_inventory", () -> new UtilInventory());

...
public enum Upgrade {
    ...
    AMBIENCE_1("ambience_1", 1, 0, 1, 3, false, "type.util"),
    AMBIENCE_2("ambience_2", 1, 0, 1, 9, false, "type.util"),
    AMBIENCE_3("ambience_3", 1, 0, 1, 27, false, "type.util"),
    AMBIENCE_4("ambience_4", 1, 0, 1, 81, false, "type.util"),
    AMBIENCE_5("ambience_5", 1, 0, 1, 243, false, "type.util"),
    ...
    FIRE_ASPECT_1("fire_aspect_1", 1, 50, 1, 0, true, "type.sword"),
    FIRE_ASPECT_2("fire_aspect_2", 1, 100, 1, 0, true, "type.sword"),
...
//    BANE_OF_ARTHROPODS_5("bane_of_arthropods_5", 5, 175, 1, 0, true, "type.sword"),
    INVINCIBILITY_SHRED_1("invincibility_shred_1", 1, 150, 1, 0.85, true, "type.sword"),
    INVINCIBILITY_SHRED_2("invincibility_shred_2", 2, 300, 1, 0.7, true, "type.sword"),
    INVINCIBILITY_SHRED_3("invincibility_shred_3", 3, 500, 1, 0.55, true, "type.sword"),
    ATTACK_SPEED_1("attack_speed_1", 1, 150, 1, 2.0, true, "type.sword"),
    ATTACK_SPEED_2("attack_speed_2", 2, 180, 1, 2.5, true, "type.sword"),
    ATTACK_SPEED_3("attack_speed_3", 3, 200, 1, 3.2, true, "type.sword"),
    ATTACK_DAMAGE_1("attack_damage_1", 1, 150, 1, 1.5, true, "type.sword"),
    ATTACK_DAMAGE_2("attack_damage_2", 2, 175, 1, 2.5, true, "type.sword"),
    ATTACK_DAMAGE_3("attack_damage_3", 3, 200, 1, 3.5, true, "type.sword"),

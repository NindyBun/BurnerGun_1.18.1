...
//    BANE_OF_ARTHROPODS_5("bane_of_arthropods_5", 5, 175, 1, 0, true, "type.sword"),
    INVINCIBILITY_SHRED_1("invincibility_shred_1", 1, 100, 1, 0.85, true, "type.sword"),
    INVINCIBILITY_SHRED_2("invincibility_shred_2", 2, 150, 1, 0.7, true, "type.sword"),
    INVINCIBILITY_SHRED_3("invincibility_shred_3", 3, 200, 1, 0.55, true, "type.sword"),
    ATTACK_SPEED_1("attack_speed_1", 1, 50, 1, 2.0, true, "type.sword"),
    ATTACK_SPEED_2("attack_speed_2", 2, 80, 1, 2.5, true, "type.sword"),
    ATTACK_SPEED_3("attack_speed_3", 3, 125, 1, 3.2, true, "type.sword"),
    ATTACK_DAMAGE_1("attack_damage_1", 1, 50, 1, 1.5, true, "type.sword"),
    ATTACK_DAMAGE_2("attack_damage_2", 2, 75, 1, 2.5, true, "type.sword"),
    ATTACK_DAMAGE_3("attack_damage_3", 3, 100, 1, 3.5, true, "type.sword"),
